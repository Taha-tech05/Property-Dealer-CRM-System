...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#0d0f14] text-[#f0f4ff] font-sans overflow-x-hidden">
      ...
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex flex-wrap items-center justify-between px-6 md:px-16 py-5 bg-[#0d0f14]/80 backdrop-blur-md border-b border-[#2a3045]/60 gap-4">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl px-6 md:px-16 pt-32 pb-20">
          ...
          <h1 className="font-bold text-4xl md:text-6xl leading-[1.05] mb-6 tracking-tight">
            Your Leads.<br />
      ...
      <div className="bg-[#161a22] border-y border-[#2a3045]">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {[["1,200+", "Leads Managed"], ["48", "Active Agents"], ["Rs2.4B", "Pipeline Value"], ["23%", "Avg. Close Rate"]].map(([val, label], i) => (
            <div key={label} className={`py-8 px-6 md:px-10 text-center ${(i === 0 || i === 2) ? "border-r border-[#2a3045]" : ""} md:border-r md:last:border-r-0`}>
              <div className="text-[#c9a84c] font-bold text-2xl md:text-3xl mb-1.5">{val}</div>
      ...
      {/* FEATURES */}
      <section className="max-w-5xl mx-auto px-6 md:px-16 py-16 md:py-24">
        <div className="text-[#c9a84c] text-xs font-semibold uppercase tracking-[3px] mb-4">Why PropCRM</div>
        <h2 className="font-bold text-3xl md:text-4xl text-[#f0f4ff] mb-4 leading-tight max-w-lg">Everything a property dealer needs</h2>
        <p className="text-[#8b92a9] text-base font-light leading-relaxed max-w-lg mb-12 md:mb-16">
      ...
      <section className="relative overflow-hidden bg-[#161a22] border-y border-[#2a3045]">
        ...
        />
        <div className="relative z-10 max-w-2xl mx-auto px-6 md:px-16 py-16 md:py-24 text-center">
          <h2 className="font-bold text-4xl md:text-5xl text-[#f0f4ff] mb-5 leading-tight">Ready to close more deals?</h2>
      ...
      {/* FOOTER */}
      <footer className="flex flex-col sm:flex-row items-center justify-between px-6 md:px-16 py-8 border-t border-[#1e2330] gap-4">
